...
data = pd.read_csv('data/dataset2_v0.csv')
...
data1 = data1.rename(columns={'Churn': 'Target'})
print(data1.columns)
print(data1.describe())

print('\nCreated a new data #2 with a size of ', data2.shape)
data2 = data2.rename(columns={'Churn': 'Target'})
print(data2.columns)
print(data2.describe())

print('\n', data1.shape, data2.shape)
data1.to_csv(r'data\dataset2_v1.csv', index=None)
data2.to_csv(r'data\dataset2_v2.csv', index=None)
